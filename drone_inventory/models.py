...
class Drone(db.Model):
    ...
    def __init__ (self, name, description, price, camera_quality, flight_time, max_speed, dimnesions, weight, cost_of_porduction, series, user_token, random_joke = '', id = ''):
        self.id = self.set_id()
        self.name = name
        ...
        self.dimensions = dimnesions
        self.weight = weight
        self.cost_of_production = cost_of_porduction 
        self.series = series
